  ...
  <footer class="border-t border-gray-800 mt-16 py-8 text-center">
    <div class="max-w-6xl mx-auto px-4">
      <p class="text-xs text-gray-600 mb-3">
        Built on <a href="https://github.com/makash/ccrank" target="_blank" rel="noopener" class="text-gray-500 hover:text-gray-300 transition">ccrank</a> by <a href="https://github.com/makash" target="_blank" rel="noopener" class="text-gray-500 hover:text-gray-300 transition">@makash</a>
        <span class="mx-1">&middot;</span> Powered by <a href="https://github.com/ryoppippi/ccusage" target="_blank" rel="noopener" class="text-gray-500 hover:text-gray-300 transition">ccusage</a>
        <span class="mx-1">&middot;</span> <a href="https://github.com/arbazkhan971/airank" target="_blank" rel="noopener" class="text-gray-500 hover:text-gray-300 transition">Open Source</a>
      </p>
      <div class="flex items-center justify-center gap-4">
        <a href="https://github.com/arbazkhan971/airank" target="_blank" rel="noopener" class="text-gray-600 hover:text-gray-300 transition" title="GitHub">
